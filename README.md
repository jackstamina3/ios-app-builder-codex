...
The Intel runner memory budget is explicitly bounded: 2 GB for Gradle, 1.5 GB for the Kotlin daemon, and 7 GB for the Kotlin/Native Release linker. The larger native-link allowance is required by Nuvio's full-distribution LTO/devirtualization pass while keeping aggregate JVM caps below the runner's 14 GB RAM.
